...
<button class="btn5" onclick="window.location='{{ route('professeur.ajouterrapport') }}'">Ajouter un Rapport</button>
...
<table>
        ...
        <tbody>
            @foreach ($rapports as $rapport)
                <tr>
                    <td>{{ $rapport->nom_professeur }}</td>
<td><a href="{{ url('' . $rapport->pdf_path) }}"><i class="fa-solid fa-file-pdf"></i>Voir le Rapport</a></td>
