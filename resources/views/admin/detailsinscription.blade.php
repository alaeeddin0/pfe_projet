...
<div class="container">
        ...
        <form action="/detailsinscription/traitement" method="POST">
        @csrf
    ...
    <input type="text" id="nom" name="nom" value="{{ $etudiant->nom }}" readonly>
</div>
<div class="form-group">
    <label for="prenom">Prénom:</label>
    <input type="text" id="prenom" name="prenom" value="{{ $etudiant->prenom }}" readonly>
</div>
<div class="form-group">
    <label for="email">Email:</label>
    <input type="email" id="email" name="email" value="{{ $etudiant->email }}" readonly>
</div>
<div class="form-group">
    <label for="username">Nom d'utilisateur:</label>
    <input type="text" id="username" name="username" value="{{ $etudiant->username }}" readonly>
</div>
<div class="form-group" style="display: none;">
    <label for="password">Nom d'utilisateur:</label>
    <input type="text" id="password" name="password" value="{{ $etudiant->password }}">
</div>
<input type="hidden" id="example-hidden" name="example-hidden" value="0">
<div class="form-group">
    <button type="submit">Valider Étudiant</button>
    <a href="{{ route('admin.DemandeInscription') }}" class="btn-back">Revenir à la liste des Étudiants</a>
</div>
