...
<div class="container">
        ...
        <form action="/updateetudiant/traitement" method="POST">
        @csrf
        ...
        <input type="text" name="id" style="display: none;" value="{{ $etudiants->id}}">
            ...
            <div class="form-group">
                ...
                <input type="text" id="nom" name="nom" value="{{ $etudiants ->nom }}">
            </div>
            <div class="form-group">
                <label for="prenom">Prénom:</label>
                <input type="text" id="prenom" name="prenom" value="{{ $etudiants -> prenom}}">
            </div>
            <div class="form-group">
                <label for="email">Email:</label>
                <input type="email" id="email" name="email" value="{{ $etudiants -> email}}">
            </div>
            <div class="form-group">
                <label for="username">Nom d'utilisateur:</label>
                <input type="text" id="username" name="username"  value="{{ $etudiants -> username}}" >
            </div>
            <div class="form-group">
                <label for="password">Mot de passe:</label>
                <input type="password" id="password" name="password"  value="{{ $etudiants -> password}}">
            </div>
            <div class="form-group">
                <button type="submit">Modifier un Étudiant</button>
                <a href="{{ route('admin.gestionetudiant') }}" class="btn-back">Revenir à la liste des Étudiants</a>
            </div>
        </form>
    </div>
