...
<table>
    ...
    @foreach($etudiants as $etudiant)
        <tr>
            ...
            <button  class="btn4" onclick="window.location='/admin/detailsinscription/{{ $etudiant->id }}'">Valider</button>
            <button onclick="window.location='/admin/declinerEtudiant/{{ $etudiant->id }}'" class="btn3">Décliner</button>
